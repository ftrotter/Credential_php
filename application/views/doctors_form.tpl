...
postal:<input type='text' name='address_correspondence_postal' id='address_correspondence_postal'value='{$address_correspondence_postal}'> 
	...
	<li>
country:<input type='text' name='address_country' id='address_country'value='{$address_country}'> 
	</li>
</ul>
	</li>
	<li>
...
0:<input type='text' name='applicant_signature' id='applicant_signature'value='{$applicant_signature}'> 
	...
	<li>
initial:<input type='text' name='applicant_initial' id='applicant_initial'value='{$applicant_initial}'> 
	</li>
</ul>
	</li>
	<li>
attached:coverage:list:is:<input type='text' name='attached_coverage_list_is' id='attached_coverage_list_is'value='{$attached_coverage_list_is}'> 
	</li>
	<li>
birth:place:<input type='text' name='birth_place' id='birth_place'value='{$birth_place}'> 
	</li>
	<li>
citizenship:<ul>
	<li>
...
name:<input type='text' name='formerhospital_0_name' id='formerhospital_0_name'value='{$formerhospital_0_name}'> 
	...
	<li>
admission:precent:<input type='text' name='formerhospital_0_admission_precent' id='formerhospital_0_admission_precent'value='{$formerhospital_0_admission_precent}'> 
	</li>
	<li>
...
fax:<input type='text' name='hospital_0_fax' id='hospital_0_fax'value='{$hospital_0_fax}'> 
	...
	<li>
admission:precent:<input type='text' name='hospital_0_admission_precent' id='hospital_0_admission_precent'value='{$hospital_0_admission_precent}'> 
	</li>
	<li>
...
is:<ul>
	<li>
military:public:health:<input type='checkbox' name='is_military_public_health' id='is_military_public_health' {if $is_military_public_health}CHECKED{/if}>
	</li>
	<li>
eligible:to:work:<input type='checkbox' name='is_eligible_to_work' id='is_eligible_to_work' {if $is_eligible_to_work}CHECKED{/if}>
	</li>
	<li>
additional:postgrad:<input type='checkbox' name='is_additional_postgrad' id='is_additional_postgrad' {if $is_additional_postgrad}CHECKED{/if}>
	</li>
	<li>
male:<input type='checkbox' name='is_male' id='is_male' {if $is_male}CHECKED{/if}>
	</li>
	<li>
more:<ul>
	<li>
formerhospitals:<input type='checkbox' name='is_more_formerhospitals' id='is_more_formerhospitals' {if $is_more_formerhospitals}CHECKED{/if}>
	</li>
	<li>
degrees:<input type='checkbox' name='is_more_degrees' id='is_more_degrees' {if $is_more_degrees}CHECKED{/if}>
	</li>
	<li>
work:history:<input type='checkbox' name='is_more_work_history' id='is_more_work_history' {if $is_more_work_history}CHECKED{/if}>
	</li>
	<li>
current:hospitals:<input type='checkbox' name='is_more_current_hospitals' id='is_more_current_hospitals' {if $is_more_current_hospitals}CHECKED{/if}>
	</li>
</ul>
	</li>
	<li>
current:military:<input type='checkbox' name='is_current_military' id='is_current_military' {if $is_current_military}CHECKED{/if}>
	</li>
	<li>
female:<input type='checkbox' name='is_female' id='is_female' {if $is_female}CHECKED{/if}>
	</li>
</ul>
	</li>
	<li>
...
middle:<input type='text' name='name_middle' id='name_middle'value='{$name_middle}'> 
	...
	<li>
maiden:<input type='text' name='name_maiden' id='name_maiden'value='{$name_maiden}'> 
	</li>
	<li>
other:<input type='text' name='name_other' id='name_other'value='{$name_other}'> 
	</li>
	<li>
...
othergrad:<ul>
	<li>
[1]:address:city:<input type='text' name='othergrad_1_address_city' id='othergrad_1_address_city'value='{$othergrad_1_address_city}'> 
	</li>
	<li>
[0]:<ul>
	<li>
...
phone:<ul>
	<li>
fax:<input type='text' name='phone_fax' id='phone_fax'value='{$phone_fax}'> 
	</li>
	<li>
correspondence:<input type='text' name='phone_correspondence' id='phone_correspondence'value='{$phone_correspondence}'> 
	</li>
	<li>
home:<input type='text' name='phone_home' id='phone_home'value='{$phone_home}'> 
	</li>
</ul>
	</li>
	<li>
...
xray:services:cert:list:<input type='text' name='practice_0_xray_services_cert_list' id='practice_0_xray_services_cert_list'value='{$practice_0_xray_services_cert_list}'> 
	...
	<li>
if:hospital:based:department:name:<input type='text' name='practice_0_if_hospital_based_department_name' id='practice_0_if_hospital_based_department_name'value='{$practice_0_if_hospital_based_department_name}'> 
	</li>
	<li>
location:listed:in:dir:is:<input type='text' name='practice_0_location_listed_in_dir_is' id='practice_0_location_listed_in_dir_is'value='{$practice_0_location_listed_in_dir_is}'> 
	...
	<li>
provider:cert:other:specify:<input type='text' name='practice_0_provider_cert_other_specify' id='practice_0_provider_cert_other_specify'value='{$practice_0_provider_cert_other_specify}'> 
	</li>
	<li>
...
service:<ul>
	<li>
branch:<input type='text' name='service_branch' id='service_branch'value='{$service_branch}'> 
	</li>
	<li>
last:location:<input type='text' name='service_last_location' id='service_last_location'value='{$service_last_location}'> 
	</li>
</ul>
	</li>
	<li>
...
speciality:<ul>
	<li>
[2]:type:<input type='text' name='speciality_2_type' id='speciality_2_type'value='{$speciality_2_type}'> 
	</li>
	<li>
[1]:type:<input type='text' name='speciality_1_type' id='speciality_1_type'value='{$speciality_1_type}'> 
	</li>
	<li>
[0]:type:<input type='text' name='speciality_0_type' id='speciality_0_type'value='{$speciality_0_type}'> 
	</li>
</ul>
	</li>
	<li>
